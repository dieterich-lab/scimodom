  ...
  firstpagebutton: ({ context }) => ({
    class: [
      ...
      // State
      {
        ...
        'focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring-2 focus-visible:ring-secondary-500 dark:focus-visible:ring-secondary-400':
          !context.disabled
      },
  ...
  pagebutton: ({ context }) => ({
    class: [
      ...
      // Color
      {
        ...
        'border-secondary-500 dark:border-secondary-400 text-secondary-500 dark:text-surface-0':
          context.active
      },
    ...
    input: {
      root: {
        class: [
          ...
          'focus-visible:outline-none focus-visible:shadow-none',
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-secondary-600 dark:focus-visible:ring-secondary-500',
          // Misc
          'cursor-pointer',
          'overflow-hidden overflow-ellipsis',
          'whitespace-nowrap',
