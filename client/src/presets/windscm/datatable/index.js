export default {
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // States
        'focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-secondary-500 dark:focus-visible:ring-secondary-400',
    ...
    filtermatchmodedropdown: {
      root: ({ state }) => ({
        class: [
          ...
          // States
          {
            'outline-none outline-offset-0 ring-2 ring-secondary-500 dark:ring-secondary-400':
              state.focused
          },
    ...
    filterrowitem: ({ context }) => ({
      class: [
        ...
        {
          'bg-secondary-500 dark:bg-secondary-400 text-white dark:text-surface-700':
            context?.highlighted
        },

        //States
        'hover:bg-secondary-500 dark:hover:bg-secondary-400 hover:text-white dark:hover:text-surface-700',
        'focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-secondary-500 dark:focus-visible:ring-secondary-400',
    ...
    filtermenubutton: ({ context }) => ({
      class: [
        ...
        'focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-inset focus:ring-secondary-500 dark:focus:ring-secondary-400',
    ...
    rowtoggler: {
      class: [
        ...
        'focus-visible:ring-2 focus-visible:ring-secondary-500 dark:focus-visible:ring-secondary-400',
      ...
      box: ({ props }) => ({
        class: [
          ...
          // States
          {
            ...
            'peer-focus-visible:ring-2 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-surface-0 dark:focus-visible:ring-offset-surface-800 peer-focus-visible:ring-secondary-500 dark:peer-focus-visible:ring-secondary-400':
              !props.disabled,
    ...
    headerCheckbox: {
      ...
      box: ({ props, context }) => ({
        class: [
          ...
          {
            'ring-2 ring-secondary-500 dark:ring-secondary-400': !props.disabled && context.focused,
            'cursor-default opacity-60': props.disabled
          },

          // States
          {
            'peer-focus-visible:ring-2 peer-focus-visible:ring-secondary-500 dark:peer-focus-visible:ring-secondary-400':
              !props.disabled,
            'cursor-default opacity-60': props.disabled
          },
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      ...
      // State
      {
        'focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-secondary-500 ring-inset dark:focus:ring-secondary-400':
          props.selectionMode
      },
      {
