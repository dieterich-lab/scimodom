import { type PlotData, type PieData, type Color } from 'plotly.js'
...
interface SunburstData extends Omit<Partial<PieData>, 'type'> {
...
async function getSunBurstData(
  ...
  try {
    ...
    return [getPlotlySunburstData(data[0]) as PlotData]
  } catch (err) {
