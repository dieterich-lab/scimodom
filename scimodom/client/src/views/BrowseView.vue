...
const initFilters = () => {
  filters.value = {
    ...
    inventoryStatus: { value: null, matchMode: FilterMatchMode.IN },
    ...
    <SectionLayout>
        ...
        <div class="card">
            ...
            <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id" 
              ...
              :globalFilterFields="['code', 'name', 'price', 'category', 'inventoryStatus']"
                ...
                <!-- <Column field="inventoryStatus" header="Status" sortable :showFilterMatchModes="false" style="min-width:12rem">
                     <template #body="slotProps">
                     <Tag :value="slotProps.data.inventoryStatus" :severity="getStatusLabel(slotProps.data.inventoryStatus)" />
                     </template>
                     <template #filter="{ filterModel }">
                     <Dropdown v-model="filterModel.value" :options="statuses" optionLabel="label" placeholder="Select One" class="p-column-filter" showClear>
                     <template #option="slotProps">
                     <Tag :value="slotProps.option.value" :severity="getStatusLabel(slotProps.option.label)" />
                     </template>
                     </Dropdown>
                     </template>
                     </Column> -->
